...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if current_rmse < best_rmse:
            ...
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, f"best_rmse_model-{best_rmse:.4f}-{best_mae:.4f}-{best_mape:.2f}%-{best_r:.2f}%.pth"))
        ...
        if current_mae < best_mae:
            ...
            any_improvement = True
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, f"best_mae_model-{best_rmse:.4f}-{best_mae:.4f}-{best_mape:.2f}%-{best_r:.2f}%.pth"))
        ...
        if current_mape < best_mape:
            ...
            any_improvement = True
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, f"best_mape_model-{best_rmse:.4f}-{best_mae:.4f}-{best_mape:.2f}%-{best_r:.2f}%.pth"))
        ...
        if current_r > best_r:
            best_r = current_r
            any_improvement = True
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, f"best_r_model-{best_rmse:.4f}-{best_mae:.4f}-{best_mape:.2f}%-{best_r:.2f}%.pth"))
